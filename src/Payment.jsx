...
const Payment = () => {
    ...
    console.log("THERE I STHE REAL DATA",doctor)
    ...
    <div className="w-full m-auto ">
         ...
         <div className="mt-2">
          <div className="flex justify-evenly w-full  h-10 items-center">
           ...
           <input type="radio" name="time" id="mor" className="scale-100 accent-black " /><label htmlFor="mor">9:45 AM</label>
        
          
           <input type="radio" name="time" id="aft" className="scale-100 accent-black " /> <label htmlFor="aft">2:00 PM</label>
           
           <input type="radio" name="time" id="eve" className="scale-100 accent-black " /><label htmlFor="eve">6:45 PM</label>
          </div>
         </div>
     </div>
     ...
     <div className=" w-[80%] ">
       ...
       <div className="m-auto w-[70%] mt-5 ">
        <button className="px-10 py-2 bg-blue-400 text-white rounded-md"><em>MAKE PAYMENT</em></button>
       </div>
    </div>
  )
}
